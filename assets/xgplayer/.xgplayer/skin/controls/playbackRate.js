import { createDom, addClass, removeClass, hasClass, toggleClass } from 'xgplayer/src/utils/util'
import sniffer from 'xgplayer/src/utils/sniffer'
import PlaybackRate from '../assets/playbackRate.svg'
...
let s_playbackRate = function () {
  ...
  tmp.push(`</ul><p class='name'>${PlaybackRate}</p>`)
